...
const doEdit = (editKey: string,editName: string,currentValue: string|undefined) =>{
  router.push({
...
<template>
  ...
  <van-cell title="性别" is-link @click="doEdit('gender','性别',user.gender.toString())" :value="user.gender" />
  ...
  <van-cell title="用户创建时间" is-link :value="user.createTime.toLocaleDateString()" />
